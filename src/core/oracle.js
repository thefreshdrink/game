...
// Было 18, потом 34 — «слишком высоко» (правки в чате, 2026-08-23, вторая
// после того же отзыва — «ещё чуть-чуть опустить»). Общее для экранов 1 и
// 2 (см. headerBottomY выше), так что фигура по-прежнему не скачет между
// ними.
export const ORACLE_TOP_GAP = 46;
